...
public class SungJukMain {
	...
	public static void main(String[] args) { //static 붙어있으면 호출만하면된다. but static으로 service 페이지만든거 아니니까 new 해준 
		SungJukService sc = new SungJukService();
		sc.menu(); // 호출
...
[5번인 경우] - sortArticle(), 기준은 이름으로 소트 
1. 이름으로 오름차순
2. 총점으로 내림차순
3. 이전 메뉴
 */
